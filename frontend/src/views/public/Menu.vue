<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-if="business?.business_data?.header_image" class="w-full h-48 md:h-64 overflow-hidden">
      <img
      ...
      <div class="max-w-7xl mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <img
              v-if="business?.business_data?.logo_image"
    ...
    <div v-else-if="categories.length > 0" class="max-w-7xl mx-auto px-4 py-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <!-- Item Image -->
          <div v-if="item.image" class="w-full h-48 overflow-hidden bg-gray-100">
            <img
              :src="item.image"
              :alt="item.title"
              class="w-full h-full object-cover"
          ...
          <div class="p-4">
            ...
            <p v-if="item.description" class="text-sm text-gray-600 mb-4 line-clamp-2">{{ item.description }}</p>
