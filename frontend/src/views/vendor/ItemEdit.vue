    ...
    <VendorLayout>
        <div class="p-4 md:p-8">
            <div class="max-w-4xl mx-auto">
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Edit Menu Item</h1>
                    <p class="text-gray-600 mt-1">Update your menu item details</p>
                </div>
                <!-- Loading State -->
                ...
                <div v-else-if="error" class="bg-white rounded-lg shadow-sm p-12 text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Error Loading Item</h3>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <!-- Image Preview -->
                                <div v-if="currentImage || imagePreview" class="flex-shrink-0">
                                    <img
...
const handleSubmit = async () => {
    ...
    try {
        ...
        await vendorStore.updateItem(itemId, formData)
...
const loadItem = async () => {
    try {
        ...
        const item = vendorStore.items.find(i => i.id === parseInt(itemId))
        ...
        // Populate form
        form.value = {
            business_link: item.business_link || '',
            title: item.title || '',
        ...
        currentImage.value = item.image || null
    } catch (err) {
