        ...
        <div class="p-4 md:p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-6">
                    ...
                    <!-- Limit Warning -->
                    <div v-if="!canCreateMoreBusinesses"
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-yellow-700 mt-1">
                                    You've reached the limit of {{ businessLimit }} businesses for your
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 capitalize">
                                    {{ authStore.user?.subscription_tier || 'Free' }}</p>
                            </div>
                    ...
                    >
                        <div class="p-6">
                            ...
                            <div class="space-y-2 mb-4">
                                <div v-if="business.business_data?.business_type"
                                ...
                                <div v-if="business.business_data?.phone_number"
                                     class="flex items-center text-sm text-gray-600">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div v-if="business.business_data?.address"
                    ...
                    <form @submit.prevent="saveBusiness" class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                />
                                <span
                                    class="px-4 py-2 bg-gray-100 border border-l-0 border-gray-300 rounded-r-lg text-sm text-gray-600">
                  .localhost:3000
                </span>
                            </div>
                        ...
                        <div v-if="editingBusiness" class="border-t pt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-start gap-4">
                                    <div v-if="headerImagePreview || editingBusiness?.business_data?.header_image"
                                         class="flex-shrink-0">
                                        <img
                                    ...
                                    <div class="flex-1">
                                        <label for="headerImageInput"
                                            ...
                                            {{
                                                headerImagePreview || editingBusiness?.business_data?.header_image ? 'Change' : 'Upload'
                                            }} Header
                                        </label>
                                        <input
                                            id="headerImageInput"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-start gap-4">
                                    <div v-if="logoImagePreview || editingBusiness?.business_data?.logo_image"
                                         class="flex-shrink-0">
                                        <img
                                    ...
                                    <div class="flex-1">
                                        <label for="logoImageInput"
                                            ...
                                            {{
                                                logoImagePreview || editingBusiness?.business_data?.logo_image ? 'Change' : 'Upload'
                                            }} Logo
                                        </label>
                                        <input
                                            id="logoImageInput"
                        ...
                        <div class="border-t pt-4">
                            <div class="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Restrict orders to customers within a specific
                                        area</p>
                                </div>
                                ...
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1 text-xs text-blue-800">
                                            <strong>Tip:</strong> You can use Google Maps to find your business
                                            coordinates.
                                            Right-click on your location and select "What's here?" to see the
                                            coordinates.
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="bg-white rounded-lg max-w-md w-full">
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-center mb-6">
                        ...
                        All associated data including menu items, tables, and servers will be permanently deleted. This
