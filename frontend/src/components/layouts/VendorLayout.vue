  ...
  <div class="min-h-screen bg-gray-50 flex">
    ...
    >
      ...
      <div class="h-16 flex items-center justify-between px-6 border-b border-gray-200">
        <router-link to="/vendor/dashboard" class="flex items-center">
          <svg class="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
          </svg>
          <span class="ml-2 text-xl font-bold text-gray-900">VendScan</span>
        </router-link>
        <button
      ...
      <div class="p-4 border-b border-gray-200">
        <div class="flex items-center">
          ...
          <div class="ml-3 flex-1 min-w-0">
            ...
            <p class="text-xs text-gray-500 capitalize">{{ authStore.user?.subscription_tier || 'Free' }} Plan</p>
          </div>
        </div>
      </div>
...
// Navigation items with SVG icons as functional components
const navigation = [
  {
    name: 'Dashboard',
